          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                infrastructure to AI-powered analytics, we help organizations scale and innovate in
                the digital age.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">solutions@acmetech.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) TECH-NOW</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Tech Updates & Insights</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Get weekly tech insights and product updates. Enterprise-focused content only.
              </p>
            </div>
          </div>
