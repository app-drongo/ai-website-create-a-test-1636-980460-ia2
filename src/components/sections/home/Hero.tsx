...
export default function Hero({
  ...
  description = 'Acme Tech Solutions delivers cutting-edge software that streamlines operations, boosts productivity, and scales with your growing business needs.',
  features = [
  ...
  imageAlt = 'Acme Tech Solutions Dashboard',
  statsLabel1 = 'Performance Boost',
  statsValue1 = '10x Faster',
  statsLabel2 = 'Client Satisfaction',
  statsValue2 = '99.8% Rating',
}: HeroProps) {
